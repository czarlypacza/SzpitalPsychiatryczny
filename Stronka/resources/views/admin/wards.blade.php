                                    ...
                                    <table class="table-striped table">
                                        ...
                                        >
                                            ...
                                            <td>
                                                <button type="button" class="btn btn-outline-dark btn-sm ms-3 me-3"
                                                        ...
                                                        data-bs-target="#ModalPatient1{{$ward->id}}">
                                                    Info
                                                </button>
                                                <div class="modal fade" id="ModalPatient1{{$ward->id}}" tabindex="-1"
                                                                ...
                                                                <div class="card">
                                                                    <div class="card-body">
                                                                        ...
                                                                        <ul class="list-group list-group-flush">
                                                                            <li class="list-group-item">Albuterol
                                                                                Sulfate
                                                                            </li>
                                                                            <li class="list-group-item">COLESTIPOL
                                                                                HYDROCHLORIDE
                                                                            </li>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <button type="button" class="btn btn-outline-dark btn-sm ms-3 me-3"
                                                        data-bs-toggle="modal"
                                                        data-bs-target="#ModalPatient2{{$ward->id}}">
                                                    Info
                                                </button>
                                                <div class="modal fade" id="ModalPatient2{{$ward->id}}" tabindex="-1"
                                                     aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <button type="button" class="btn btn-outline-dark btn-sm ms-3 me-3"
                                                        data-bs-toggle="modal"
                                                        data-bs-target="#ModalPatient3{{$ward->id}}">
                                                    Info
                                                </button>
                                                <div class="modal fade" id="ModalPatient3{{$ward->id}}" tabindex="-1"
                                                     aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <button type="button" class="btn btn-outline-dark btn-sm ms-3 me-3"
                                                        data-bs-toggle="modal"
                                                        data-bs-target="#ModalPatient4{{$ward->id}}">
                                                    Info
                                                </button>
                                                <div class="modal fade" id="ModalPatient4{{$ward->id}}" tabindex="-1"
                                                     aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
